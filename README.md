...
* Request
  * Method: POST
  * URL: "users/:userId/spots/:spotsId/reviews/:reviewId/images"
  * Headers:
    * Content-Type: application/json
  * Body:
...
* Request
  * Method: PUT
  * URL: "users/:userId/spots/:spotId/reveiws/:reviewId"
  * Headers:
    * Content-Type: application/json
  * Body:
...
* Request
  * Method: DELETE
  * URL: "users/:userId/spots/:spotId/reviews/:reviewId"
  * Body: none
...
* Request
  * Method: GET
  * URL: "users/:userId/spots/:spotId/bookings"
  * Body: none
...
* Request
  * Method: DELETE
  * URL: "/users/:userId/spots/:spotId/review/:reviewId/images/:imageId"
  * Body: none
...
* Request
  * Method: GET
  * URL: "/spots/search?page=0&size=20"
  * Query Parameters
